...
set THISFILENAME=%~n0
set CONFIG=%THISFILENAME:is23X_complete_datapreparation_=%
...
rem python %script_prefix%\step33_analyze_data.py --config_path=%config_file%
rem python %script_prefix%\step34_analyze_temporal_data.py --config_path=%config_file%
rem python %script_prefix%\step35_perform_feature_selection.py --config_path=%config_file%
rem python %script_prefix%\step36_split_training_validation.py --config_path=%config_file%
